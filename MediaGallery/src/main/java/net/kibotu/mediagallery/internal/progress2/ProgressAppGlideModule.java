package net.kibotu.mediagallery.internal.progress2;
...
//
//            Log.v("OkHttpProgressResponse", "contentLength=" + responseBody.contentLength() + " contentType=" + responseBody.contentType());
//
//            this.url = url;
