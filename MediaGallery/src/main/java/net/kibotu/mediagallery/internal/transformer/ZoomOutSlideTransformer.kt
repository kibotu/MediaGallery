...
class ZoomOutSlideTransformer(private val minScale: Float = 0.85f, private val minAlpha: Float = 0.75f) : BaseTransformer() {

    override fun onTransform(view: View, position: Float) {

        val background = view.findViewById<View>(R.id.imageBackground)
        ...
        background.alpha = minAlpha + (scaleFactor - minScale) / 0.14999998F * minAlpha
    }
}